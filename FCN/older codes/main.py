...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    vgg_layer7_logits = tf.compat.v1.layers.conv2d(
        ...
        kernel_initializer= tf.compat.v1.random_normal_initializer(stddev=0.01), name='vgg_layer7_logits')
        #kernel_regularizer= tf.compat.v1.layers.l2_regularizer(1e-4), name='vgg_layer7_logits')
    vgg_layer4_logits = tf.compat.v1.layers.conv2d(
        vgg_layer4_out, num_classes, kernel_size=1,
        kernel_initializer= tf.compat.v1.random_normal_initializer(stddev=0.01),name='vgg_layer4_logits')
        #kernel_regularizer= tf.layers.l2_regularizer(1e-4), name='vgg_layer4_logits')
    vgg_layer3_logits = tf.compat.v1.layers.conv2d(
        vgg_layer3_out, num_classes, kernel_size=1,
        kernel_initializer= tf.compat.v1.random_normal_initializer(stddev=0.01),name='vgg_layer3_logits')
        #kernel_regularizer= tf.compat.v1.contrib.layers.l2_regularizer(1e-4), name='vgg_layer3_logits')
    ...
    fcn_decoder_layer1 = tf.compat.v1.layers.conv2d_transpose(
        ...
        padding='same',
        kernel_initializer= tf.compat.v1.random_normal_initializer(stddev=0.01),name='fcn_decoder_layer1')
        #kernel_regularizer= tf.compat.v1.contrib.layers.l2_regularizer(1e-4), name='fcn_decoder_layer1')
    ...
    fcn_decoder_layer3 = tf.compat.v1.layers.conv2d_transpose(
        ...
        padding='same',
        kernel_initializer= tf.compat.v1.random_normal_initializer(stddev=0.01), name='fcn_decoder_layer3')
        #kernel_regularizer= tf.compat.v1.contrib.layers.l2_regularizer(1e-4), name='fcn_decoder_layer3')
    ...
    fcn_decoder_output = tf.compat.v1.layers.conv2d_transpose(
        ...
        padding='same',
        kernel_initializer= tf.random_normal_initializer(stddev=0.01),name='fcn_decoder_layer4')
